...
public class ShotCalculator {
  ...
  static {
    ...
    double[][] scoringData = {
        ...
        { 4.237, 0.190, 201 + UNIVERSAL_FLYWHEEL_MOD+0.75, 1.33 },
        { 4.4464, 0.194, 208 + UNIVERSAL_FLYWHEEL_MOD+0.75, 1.35 }, // Newer TIF
        { 4.595, 0.2102, 207.158 + UNIVERSAL_FLYWHEEL_MOD+0.75, 1.374 }, // new TIF
        { 4.795, 0.230, 210.7 + UNIVERSAL_FLYWHEEL_MOD+0.75, 1.4 },
        { 5.074, 0.23784, 221.2 + UNIVERSAL_FLYWHEEL_MOD+0.75, 1.36 }, // New TIF
        { 5.475, 0.233, 232 + UNIVERSAL_FLYWHEEL_MOD+0.75, 1.38 }, // New
        { 5.770, 0.238, 240 + UNIVERSAL_FLYWHEEL_MOD+0.75, 1.66 }, // New TIF
        { 6.258, 0.248, 252 + UNIVERSAL_FLYWHEEL_MOD+0.75, 1.72 }
    };
  ...
  public static ShootingParams getHubParams(Pose2d pose, ChassisSpeeds robotVelocity, ChassisSpeeds robotAcceleration) {
    ...
    return getParams(pose, robotVelocity, robotAcceleration, target, shotHoodAngleMap, shotFlywheelSpeedMap,
        timeOfFlightMap, true,
  ...
  public static ShootingParams getPassParams(Pose2d pose, ChassisSpeeds robotVelocity,
    ...
    if (GeomUtil.doesLinePassThroughArea(shotPath, AllianceFlipUtil.apply(FieldConstants.passExclusionZone))) {
      isValid = false;
    }
    return getParams(pose, robotVelocity, robotAcceleration, targetPose, passHoodAngleMap, passFlywheelSpeedMap,
        passTimeOfFlightMap,
   ...
   */
  private static ShootingParams getParams(Pose2d robotPose, ChassisSpeeds robotVelocity,
      ChassisSpeeds robotAcceleration, Translation2d target,
    ...
    Rotation2d turretAngle = target.minus(lookAheadPose.getTranslation()).getAngle()
        .minus(new Rotation2d(robotVelocity.omegaRadiansPerSecond * thetaExtraDelay));
