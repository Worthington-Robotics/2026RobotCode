...
public class ShotCalculatorI {
  ...
  static {
    ...
    // flight (sec)
    double[][] scoringData = {
        { 2.067517874264592, 0.226, 132, 1 },
        { 2.981151807004248, 0.265, 147, 1.000349 },
        { 3.8951452800012, 0.375, 159, 1.1 },
        { 4.809293308638241, 0.384, 181.3, 1.2237 },
    };
   ...
   */
  private static ShootingParams getParams(Pose2d robotPose, ChassisSpeeds robotVelocity, Translation2d target,
