...
public class Climber extends SubsystemBase {
  ...
  private boolean climbLock = true;
  ...
  public Climber(ClimberIO io) {
    ...
    climberController.pid.setTolerance(Constants.ClimberConstants.CLIMBER_POS_TOLERANCE);
  }
  ...
  public boolean isClimbLock(){
    return climbLock;
  }

  public void setClimbLock(boolean climb){
    climbLock = climb;
  }
}
