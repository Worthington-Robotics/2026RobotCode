...
public class DriveController {
  ...
  public static final double DRIVE_SPEED_MULTIPLIER = 0.52;
   ...
   */
  public static final double TURN_PREDICTION_FACTOR = 55.0;

  private static final LinearFilter driveFilter = LinearFilter.movingAverage(5);
  private static final LinearFilter xFilter = LinearFilter.movingAverage(25);
  private static final LinearFilter yFilter = LinearFilter.movingAverage(25);
