...
public class IntakeCommands {
    ...
    /***
     * Command to extend the intake, works by supplying voltage to the extending motor
    ...
    /***
     * Command to retract the intake, works by supplying voltage to the extending motor in the 
     * opposite direction
     * @param extend 
     * @return
     */
